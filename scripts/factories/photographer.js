function photographerFactory (data) {
  ...
  function getUserCardDOM () {
    ...
    a.innerHTML = `<img tabindex='1' aria-label="portrait de ${name}" src="assets/photographers/${portrait}"/> <h2 aria-label="Le nom du photographe est ${name}" tabindex='1' >${name}</h2> `
